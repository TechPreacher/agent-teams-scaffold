...
```bash
python3 scripts/scaffold.py --repo <TARGET_REPO> [--scopes auth,input,supplychain,secrets] [--team-name NAME] [--force]
```
...
### 2. Tailor the generated files (this is the part only you can do)
